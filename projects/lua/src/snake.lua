...
-- I REPEAT, CTRL+F IS YOUR FRIEND HERE :)
...
Game = {
    Snake = {
        ...
        init = function(row, col)
            ...
            Game.Snake.head = Game.Snake.body_piece(row, col)
            Game.Snake.tail = Game.Snake.body_piece(row-1, col)
            Game.Snake.tail.next = Game.Snake.head
            -- finally, use the set_piece function in the Screen field to put a
            -- snake piece on the current row/col
            Game.Screen.set_piece(row, col, Game.Piece.snake)
        end,
        ...
        get_next_head_position = function()
            ...
            return Game.Snake.head.row + Game.Snake.d_row, Game.Snake.head.col + Game.Snake.d_col
        end,
    ...
    Screen = {
        ...
        init = function(min_row, min_col, max_row, max_col)
            ...
            Game.Screen.min_row, Game.Screen.min_col, Game.Screen.max_row, Game.Screen.max_col = min_row, min_col, max_row, max_col
        ...
        invalid_position = function(row, col)
            ...
            return row < Game.Screen.min_row or row > Game.Screen.max_row or col < Game.Screen.min_col or col > Game.Screen.max_col
        end,
        get_piece = function(row, col)
            ...
            if not Game.Screen.invalid_position(row, col) then
                return Game.Screen.board[row][col]
            end
            return Game.Piece.unk
        end,
